...
for i=5   
   ...
   for v=69:length(vars)
      ...
      realm=translate_cesm(cesm_dictionary,local_var_spec.modeling_realm,'Realms',0);
      frequency=translate_cesm(cesm_dictionary,local_var_spec.frequency,'Frequency',0);
      variables_list=translate_cesm(cesm_dictionary,vars{v},'Variables',0);
